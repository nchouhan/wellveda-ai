...
export const images = {
  ...
  herbs2:
    "https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  herbs4:
    "https://images.unsplash.com/photo-1515364229230-7bfd3b94c2d2?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",

  // Calming natural backgrounds
  nature1:
    "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  nature2:
    "https://images.unsplash.com/photo-1520962880247-cfaf541c8724?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  nature3:
    "https://images.unsplash.com/photo-1572099606223-6e29045d7de3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
